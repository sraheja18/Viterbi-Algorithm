...
class Hmm(object):
    ...
    def preprocess(self, corpus_file):
        """Preprocess the train file to categorize rare words into one category"""
        c = Counter()
    ...
    def base_tagger(self, filename):
        """Unigram model"""
        f = open("gene_dev_baseline.p1.out", "w")
    ...
    def viterbi(self, filename):
        """Trigram HMM model using Viterbi"""
        f = open("gene_dev.viterbi_baseline", "w")
